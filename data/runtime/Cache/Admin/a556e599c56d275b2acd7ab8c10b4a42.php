...
<body>
	<div class="wrap js-check-wrap" id="app">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo U('Member/index');?>">客户列表</a></li>
		...
		<form class="form-horizontal" id="tagforms" method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="nicename" maxlength="10" value="<?php echo ($nicename); ?>" placeholder="姓名限制10字以内">
					</div>
				</div>
				<div class="control-group">
					<label class="control-label">客户电话：</label>
					<div class="controls">
						<input type="text" name="mobile" maxlength="11" value="<?php echo ($mobile); ?>" placeholder="请输入手机号码">
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<select name="sex">
							<option value="3" <?php if($sex == 3): ?>selected<?php endif; ?>>其他</option>	
			...
			<div class="form-actions">
				...
				<input type="hidden" name="oldname" value="<?php echo ($mobile); ?>">
		...
		var app = new Vue({
			...
			methods:{
				add:function () {	
					...
					$.ajax({
						url:'<?php echo U("Member/edit_post");?>',
						data:tagvals,
						type:"POST",
						dataType:"json",
